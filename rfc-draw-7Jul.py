...
import draw_headers_class_26 as dhc   # Handles pkt header objects
...
print("rdg: save_file_name >%s<" % rdg,save_file_name)
...
last_mode = rdg.read_from_rdd(save_file_name)
    # Reads the save_file
print("last_mode was %s" % last_mode)  # 'rect' if no save_file
