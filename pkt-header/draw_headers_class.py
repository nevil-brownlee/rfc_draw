# 1641, Fri 24 Nov 2023 (NZDT)  Copied from draw_lines_class.py
#
...
"""
Functions:
  start_new_header()  b1_click and drag to start new header diagram

"""

class draw_headers:  # header objects for rfc-draw
